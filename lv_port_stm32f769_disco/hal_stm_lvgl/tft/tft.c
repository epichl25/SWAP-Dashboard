 ...
 *      MACROS
 **********************/
uint8_t BrightnessValue;  //Screen's brightness value (1-100)
int scrn_stat_flag=0;  //Screen status flag <== turned on=0, turned off=1
int scrnTimeout_flag=0; //Screen timeout (duration) settings
/**********************
 *   GLOBAL FUNCTIONS
 **********************/
