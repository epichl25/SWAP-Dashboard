...
char *WIFI_SSID;
char *WIFI_PWD;
char mqtt_broker[]="192.168.50.221";
char mqtt_username[]="test";  //authentication credentials
char mqtt_password[]="12345";  //authentication credentials
char mqtt_port[]="1883";  //port
char device_ID[]="stm32F7";  //Device name
char opening[]="<";
char closing[]=">";
char equal[]="=";
char semicln[]=";";
